---
title: 'Mac Latex环境配置'
description: '配好了Mac下的Latex使用环境，争取早目卸载Mac上的虚拟机 使用软件: MacTex + Sublime 3 + Skim 参考了几个知乎答案，现总结如下： 1. ＭacTex 安装 2. Sublime 3 Package Control 3. Skim 安装 4. Sublime中安装La'
date: '2015-10-28'
readTime: '3 min read'
image: '/assets/images/posts/post1.jpg'
slug: 'mac-latex-e7-8e-af-e5-a2-83-e9-85-8d-e7-bd-ae'
---
