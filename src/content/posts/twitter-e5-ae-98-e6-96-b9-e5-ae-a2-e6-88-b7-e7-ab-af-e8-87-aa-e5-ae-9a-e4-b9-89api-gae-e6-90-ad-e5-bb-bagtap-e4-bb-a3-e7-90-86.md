...
description: '有方法而不尝试的感觉是十分让我无法忍受的，今天中午终于走出了这一步，按网上的教程建了个Gtap的twitter api，从目前的情况看，短期内api终于不用求人了…………. 方法记录如下： 1\. 注册Google App Engine 进 用google帐户登陆，需要用手机收一个验证码，地区选Ot'
date: '2010-07-30'
readTime: '3 min read'
image: '/assets/images/posts/post1.jpg'
slug: 'twitter-e5-ae-98-e6-96-b9-e5-ae-a2-e6-88-b7-e7-ab-af-e8-87-aa-e5-ae-9a-e4-b9-89api-gae-e6-90-ad-e5-bb-bagtap-e4-bb-a3-e7-90-86'
---
